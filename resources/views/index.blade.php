              ...
              <div>
                ...
                <div class="timeline-item">
                  ...
                  <div class="timeline-body">
                    <img src="{{ Storage::url($item->photo) }}" alt="..." width="300" height="300">
                  </div>
             <div class="row mb-3">
                ...
                <form action="{{ route('galery.destroy', $item->id) }}" method="post">
                    @csrf
                    @method('DELETE')
                    <button id="delete" class="btn btn-danger mr-3" onclick="return confirm('Apakah Mau Hapus?')"><span class="fas fa-trash can"></span></button>
